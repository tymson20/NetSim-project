...
public:
    ...
    const_iterator cbegin() override { return packages_.cbegin(); }
    const_iterator cbegin() const override { return packages_.begin(); }
    const_iterator cend() override { return packages_.cend(); }
    const_iterator cend() const override { return packages_.end(); }
